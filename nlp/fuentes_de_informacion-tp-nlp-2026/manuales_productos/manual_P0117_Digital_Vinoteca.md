# Manual Técnico - Digital Vinoteca

**Modelo:** P0117 | **Marca:** HomeChef
...
- **Modelo:** P0117
- **Nombre Comercial:** Digital Vinoteca
...
### Unidad Principal
**Código:** `UNI-P0117-001`

Componente central del equipo. Potencia: 550W. Material: ABS de alto impacto.

### Panel táctil
**Código:** `PAN-P0117-002`

Bloqueo de seguridad para niños, Temporizador programable, Control de temperatura

### Sistema de Seguridad
**Código:** `SEG-P0117-003`
...
- **Batidora de Pie II** (`P0021`)
  - Comparte: Jarra
- **Premium Molinillo de Café** (`P0039`)
  - Comparte: Panel de control
- **Eco Waflera** (`P0065`)
  - Comparte: Motor
- **Vinoteca II** (`P0119`)
...
*Documento generado: P0117 - Digital Vinoteca*
