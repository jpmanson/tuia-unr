# Manual Técnico - Frigobar

**Modelo:** P0111 | **Marca:** TechHome
...
### Unidad Principal
**Código:** `UNI-P0111-001`

Componente central del equipo. Potencia: 300W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0111-002`

Interfaz intuitiva, Bloqueo de seguridad para niños, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0111-003`

Interruptor de sobrecarga, Base antideslizante, Fusible térmico reseteable
...
- **Olla de Cocción Lenta** (`P0084`)
  - Comparte: Motor
- **Deluxe Procesadora** (`P0010`)
  - Comparte: Accesorios
- **Profesional Mixer** (`P0024`)
  - Comparte: Cuchillas
- **Ultra Parrilla Eléctrica** (`P0071`)
  - Comparte: Jarra
- **Profesional Freezer** (`P0101`)
...
*Documento generado: P0111 - Frigobar*
