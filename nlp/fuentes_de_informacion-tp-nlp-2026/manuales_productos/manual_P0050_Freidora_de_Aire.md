...
### Unidad Principal
**Código:** `UNI-P0050-001`

Componente central del equipo. Potencia: 1000W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0050-002`

Control de temperatura, Bloqueo de seguridad para niños, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0050-003`
...
- **Plus Parrilla Eléctrica** (`P0074`)
  - Comparte: Jarra
- **Turbo Abridor de Latas** (`P0034`)
  - Comparte: Panel de control
- **Deluxe Yogurtera 3000** (`P0139`)
  - Comparte: Motor
- **Olla de Cocción Lenta X** (`P0090`)
  - Comparte: Jarra
- **Smart Conservadora 2024** (`P0107`)
  - Comparte: Panel de control
...
*Documento generado: P0050 - Freidora de Aire*
