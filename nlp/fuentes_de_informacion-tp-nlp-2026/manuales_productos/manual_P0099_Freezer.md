# Manual Técnico - Freezer

**Modelo:** P0099 | **Marca:** CookElite
...
### Unidad Principal
**Código:** `UNI-P0099-001`

Componente central del equipo. Potencia: 1900W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0099-002`

Indicadores luminosos, Temporizador programable, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0099-003`

Base antideslizante, Apagado automático, Fusible térmico reseteable
...
- **Vinoteca Pro** (`P0115`)
  - Comparte: Jarra
- **Olla de Cocción Lenta II** (`P0083`)
  - Comparte: Cuchillas
- **Max Conservadora** (`P0105`)
  - Comparte: Jarra
- **Advanced Pava Eléctrica** (`P0128`)
  - Comparte: Motor
...
*Documento generado: P0099 - Freezer*
