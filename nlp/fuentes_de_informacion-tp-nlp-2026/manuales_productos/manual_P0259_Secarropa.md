...
### Unidad Principal
**Código:** `UNI-P0259-001`

Componente central del equipo. Potencia: 750W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0259-002`

Interfaz intuitiva, Control de temperatura, Indicadores luminosos

### Sistema de Seguridad
**Código:** `SEG-P0259-003`

Base antideslizante, Fusible térmico reseteable, Sistema anti-derrames
...
- **Premium Lavarropa Carga Frontal** (`P0247`)
  - Comparte: Accesorios
- **Plancha Seca II** (`P0288`)
  - Comparte: Jarra
- **Planchita de Pelo** (`P0297`)
  - Comparte: Accesorios
- **Plus Lavarropa Carga Frontal II** (`P0244`)
  - Comparte: Cuchillas
...
*Documento generado: P0259 - Secarropa*
