# Manual Técnico - Digital Horno Eléctrico

**Modelo:** P0041 | **Marca:** CookElite
...
- **Modelo:** P0041
- **Nombre Comercial:** Digital Horno Eléctrico
- **Categoría:** Cocina - Cocción
- **Marca:** CookElite
- **Color:** Amarillo
- **Potencia:** 1500W
- **Voltaje:** 12V
...
### Unidad Principal
**Código:** `UNI-P0041-001`

Componente central del equipo. Potencia: 1500W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0041-002`

Bloqueo de seguridad para niños, Temporizador programable, Indicadores luminosos

### Sistema de Seguridad
**Código:** `SEG-P0041-003`

Interruptor de sobrecarga, Detección de sobrecalentamiento, Apagado automático
...
*Documento generado: P0041 - Digital Horno Eléctrico*
