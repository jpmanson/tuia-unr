# Manual Técnico - Ventilador de Torre 2024

**Modelo:** P0195 | **Marca:** AirFlow
...
- **Modelo:** P0195
- **Nombre Comercial:** Ventilador de Torre 2024
...
### Unidad Principal
**Código:** `UNI-P0195-001`

Componente central del equipo. Potencia: 90W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0195-002`

Interfaz intuitiva, Control de temperatura, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0195-003`
...
- **Digital Panel Calefactor** (`P0175`)
  - Comparte: Accesorios
...
*Documento generado: P0195 - Ventilador de Torre 2024*
