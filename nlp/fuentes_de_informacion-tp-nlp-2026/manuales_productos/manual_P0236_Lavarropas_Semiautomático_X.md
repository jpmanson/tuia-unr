...
### Unidad Principal
**Código:** `UNI-P0236-001`

Componente central del equipo. Potencia: 550W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0236-002`

Interfaz intuitiva, Temporizador programable, Control de temperatura

### Sistema de Seguridad
**Código:** `SEG-P0236-003`

Detección de sobrecalentamiento, Base antideslizante, Interruptor de sobrecarga
...
*Documento generado: P0236 - Lavarropas Semiautomático X*
