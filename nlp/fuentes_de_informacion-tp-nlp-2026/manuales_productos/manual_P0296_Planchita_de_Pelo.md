# Manual Técnico - Planchita de Pelo

**Modelo:** P0296 | **Marca:** LaundryTech
...
- **Modelo:** P0296
- **Nombre Comercial:** Planchita de Pelo
...
### Unidad Principal
**Código:** `UNI-P0296-001`

Componente central del equipo. Potencia: 1850W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0296-002`

Bloqueo de seguridad para niños, Control de temperatura, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0296-003`

Sistema anti-derrames, Bloqueo de tapa, Base antideslizante
...
- **Pro Tender Eléctrico** (`P0271`)
  - Comparte: Jarra
- **Planchita de Pelo** (`P0298`)
  - Comparte: Accesorios
- **Digital Plancha a Vapor Plus** (`P0283`)
  - Comparte: Jarra
- **Smart Secarropa** (`P0256`)
  - Comparte: Panel de control
- **Lavarropa Carga Superior** (`P0237`)
  - Comparte: Panel de control
...
*Documento generado: P0296 - Planchita de Pelo*
