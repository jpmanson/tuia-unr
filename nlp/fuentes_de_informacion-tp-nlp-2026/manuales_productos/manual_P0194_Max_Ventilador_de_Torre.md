# Manual Técnico - Max Ventilador de Torre

**Modelo:** P0194 | **Marca:** AirFlow
...
- **Modelo:** P0194
- **Nombre Comercial:** Max Ventilador de Torre
- **Categoría:** Climatización - Ventilación
- **Marca:** AirFlow
- **Color:** Blanco
- **Potencia:** 40W
- **Voltaje:** 220V
...
### Unidad Principal
**Código:** `UNI-P0194-001`

Componente central del equipo. Potencia: 40W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0194-002`

Bloqueo de seguridad para niños, Temporizador programable, Indicadores luminosos

### Sistema de Seguridad
**Código:** `SEG-P0194-003`

Fusible térmico reseteable, Detección de sobrecalentamiento, Base antideslizante
...
- **Advanced Humidificador** (`P0216`)
  - Comparte: Motor
- **Ventilador de Pie 2024** (`P0186`)
  - Comparte: Cuchillas
- **Neblinizador** (`P0204`)
  - Comparte: Accesorios
- **Panel Calefactor** (`P0178`)
  - Comparte: Accesorios
...
*Documento generado: P0194 - Max Ventilador de Torre*
