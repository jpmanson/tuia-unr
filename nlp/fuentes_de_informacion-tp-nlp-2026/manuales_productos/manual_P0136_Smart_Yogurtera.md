# Manual Técnico - Smart Yogurtera

**Modelo:** P0136 | **Marca:** CookElite
...
- **Modelo:** P0136
- **Nombre Comercial:** Smart Yogurtera
...
### Unidad Principal
**Código:** `UNI-P0136-001`

Componente central del equipo. Potencia: 1350W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0136-002`

Indicadores luminosos, Bloqueo de seguridad para niños, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0136-003`

Bloqueo de tapa, Apagado automático, Sistema anti-derrames
...
- **Max Conservadora** (`P0105`)
  - Comparte: Panel de control
- **Elite Heladera** (`P0094`)
  - Comparte: Motor
- **Vinoteca Pro** (`P0115`)
  - Comparte: Cuchillas
- **Plus Olla de Cocción Lenta** (`P0089`)
  - Comparte: Panel de control
- **Premium Heladera** (`P0096`)
  - Comparte: Cuchillas
...
*Documento generado: P0136 - Smart Yogurtera*
