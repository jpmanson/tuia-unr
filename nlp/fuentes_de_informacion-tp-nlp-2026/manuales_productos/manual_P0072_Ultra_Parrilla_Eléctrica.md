# Manual Técnico - Ultra Parrilla Eléctrica

**Modelo:** P0072 | **Marca:** TechHome
...
- **Modelo:** P0072
- **Nombre Comercial:** Ultra Parrilla Eléctrica
...
### Unidad Principal
**Código:** `UNI-P0072-001`

Componente central del equipo. Potencia: 900W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0072-002`

Bloqueo de seguridad para niños, Temporizador programable, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0072-003`

Detección de sobrecalentamiento, Bloqueo de tapa, Interruptor de sobrecarga
...
*Documento generado: P0072 - Ultra Parrilla Eléctrica*
