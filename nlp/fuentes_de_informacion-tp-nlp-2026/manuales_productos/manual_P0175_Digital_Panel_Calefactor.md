# Manual Técnico - Digital Panel Calefactor

**Modelo:** P0175 | **Marca:** AirFlow
...
- **Modelo:** P0175
- **Nombre Comercial:** Digital Panel Calefactor
...
### Unidad Principal
**Código:** `UNI-P0175-001`

Componente central del equipo. Potencia: 1200W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0175-002`

Temporizador programable, Indicadores luminosos, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0175-003`

Interruptor de sobrecarga, Sistema anti-derrames, Apagado automático
...
- **Ventilador de Torre 2024** (`P0195`)
  - Comparte: Cuchillas
- **Aire Central Pro** (`P0161`)
  - Comparte: Jarra
- **Max Ventilador de Torre** (`P0194`)
  - Comparte: Cuchillas
- **Ventilador de Techo X** (`P0192`)
  - Comparte: Accesorios
- **Ultra Humidificador** (`P0212`)
  - Comparte: Accesorios
...
Este producto cuenta con **18 meses de garantía** contra defectos de fabricación.
...
*Documento generado: P0175 - Digital Panel Calefactor*
