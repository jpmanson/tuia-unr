# Manual Técnico - Pro Ventilador de Pie

**Modelo:** P0184 | **Marca:** EcoClima
...
- **Modelo:** P0184
- **Nombre Comercial:** Pro Ventilador de Pie
...
### Unidad Principal
**Código:** `UNI-P0184-001`

Componente central del equipo. Potencia: 40W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0184-002`

Control de temperatura, Bloqueo de seguridad para niños, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0184-003`

Fusible térmico reseteable, Detección de sobrecalentamiento, Interruptor de sobrecarga
...
- **Aire Portátil** (`P0155`)
  - Comparte: Cuchillas
- **Panel Calefactor** (`P0179`)
  - Comparte: Jarra
- **Purificador de Aire 3000** (`P0208`)
  - Comparte: Jarra
- **Pro Deshumidificador Pro** (`P0221`)
  - Comparte: Jarra
- **Radiador de Aceite II** (`P0181`)
  - Comparte: Motor
...
**EcoClima** - Servicio de Atención al Cliente
...
*Documento generado: P0184 - Pro Ventilador de Pie*
