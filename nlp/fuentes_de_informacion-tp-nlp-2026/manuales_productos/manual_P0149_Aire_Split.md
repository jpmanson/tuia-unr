...
### Unidad Principal
**Código:** `UNI-P0149-001`

Componente central del equipo. Potencia: 1150W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0149-002`

Control de temperatura, Bloqueo de seguridad para niños, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0149-003`

Apagado automático, Bloqueo de tapa, Sistema anti-derrames
...
- **Elite Humidificador** (`P0210`)
  - Comparte: Jarra
- **Smart Ventilador de Pie** (`P0187`)
  - Comparte: Motor
...
*Documento generado: P0149 - Aire Split*
