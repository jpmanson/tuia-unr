# Manual Técnico - Plancha Seca II

**Modelo:** P0288 | **Marca:** FreshWash
...
- **Modelo:** P0288
- **Nombre Comercial:** Plancha Seca II
...
### Unidad Principal
**Código:** `UNI-P0288-001`

Componente central del equipo. Potencia: 400W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0288-002`

Interfaz intuitiva, Indicadores luminosos, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0288-003`

Sistema anti-derrames, Base antideslizante, Fusible térmico reseteable
...
- **Planchita de Pelo** (`P0297`)
  - Comparte: Accesorios
- **Elite Lavaseca** (`P0249`)
  - Comparte: Panel de control
- **Turbo Secarropa** (`P0257`)
  - Comparte: Motor
- **Centrifuga Pro** (`P0266`)
  - Comparte: Motor
- **Secarropa** (`P0259`)
  - Comparte: Panel de control
...
*Documento generado: P0288 - Plancha Seca II*
