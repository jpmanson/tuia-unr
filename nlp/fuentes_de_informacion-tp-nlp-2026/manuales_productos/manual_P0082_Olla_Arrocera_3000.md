# Manual Técnico - Olla Arrocera 3000

**Modelo:** P0082 | **Marca:** HomeChef
...
- **Modelo:** P0082
- **Nombre Comercial:** Olla Arrocera 3000
...
### Unidad Principal
**Código:** `UNI-P0082-001`

Componente central del equipo. Potencia: 1600W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0082-002`

Indicadores luminosos, Bloqueo de seguridad para niños, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0082-003`

Apagado automático, Base antideslizante, Sistema anti-derrames
...
- **Eco Waflera** (`P0065`)
  - Comparte: Jarra
- **Digital Sandwichera Plus** (`P0062`)
  - Comparte: Accesorios
- **Profesional Procesadora 2024** (`P0011`)
  - Comparte: Motor
- **Abridor de Latas** (`P0033`)
  - Comparte: Accesorios
...
*Documento generado: P0082 - Olla Arrocera 3000*
