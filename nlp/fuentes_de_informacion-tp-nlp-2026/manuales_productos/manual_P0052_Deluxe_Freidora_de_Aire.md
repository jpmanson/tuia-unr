# Manual Técnico - Deluxe Freidora de Aire

**Modelo:** P0052 | **Marca:** ChefMaster
...
- **Modelo:** P0052
- **Nombre Comercial:** Deluxe Freidora de Aire
...
### Unidad Principal
**Código:** `UNI-P0052-001`

Componente central del equipo. Potencia: 1450W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0052-002`

Control de temperatura, Interfaz intuitiva, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0052-003`

Base antideslizante, Bloqueo de tapa, Fusible térmico reseteable
...
- **Eco Conservadora II** (`P0104`)
  - Comparte: Cuchillas
- **Deluxe Exprimidor X** (`P0130`)
  - Comparte: Accesorios
- **Advanced Heladera** (`P0091`)
...
**ChefMaster** - Servicio de Atención al Cliente
...
*Documento generado: P0052 - Deluxe Freidora de Aire*
