# Manual Técnico - Turbo Pava Eléctrica 2024

**Modelo:** P0126 | **Marca:** HomeChef
...
- **Modelo:** P0126
- **Nombre Comercial:** Turbo Pava Eléctrica 2024
- **Categoría:** Cocina - Pequeños Electrodomésticos
- **Marca:** HomeChef
- **Color:** Verde
- **Potencia:** 1450W
- **Voltaje:** 12V
...
### Unidad Principal
**Código:** `UNI-P0126-001`

Componente central del equipo. Potencia: 1450W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0126-002`

Indicadores luminosos, Temporizador programable, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0126-003`

Bloqueo de tapa, Base antideslizante, Sistema anti-derrames
...
- **Olla de Cocción Lenta Plus** (`P0088`)
  - Comparte: Panel de control
- **Pava Eléctrica 2024** (`P0124`)
  - Comparte: Accesorios
- **Mixer II** (`P0026`)
  - Comparte: Accesorios
- **Batidora de Mano II** (`P0018`)
  - Comparte: Cuchillas
- **Advanced Yogurtera** (`P0138`)
  - Comparte: Cuchillas
...
**HomeChef** - Servicio de Atención al Cliente
...
*Documento generado: P0126 - Turbo Pava Eléctrica 2024*
