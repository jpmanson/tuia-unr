# Manual Técnico - Super Panel Calefactor Plus

**Modelo:** P0177 | **Marca:** AirFlow
...
- **Modelo:** P0177
- **Nombre Comercial:** Super Panel Calefactor Plus
- **Categoría:** Climatización - Calefacción
- **Marca:** AirFlow
- **Color:** Gris
- **Potencia:** 1750W
- **Voltaje:** 110-220V
...
### Unidad Principal
**Código:** `UNI-P0177-001`

Componente central del equipo. Potencia: 1750W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0177-002`

Bloqueo de seguridad para niños, Control de temperatura, Indicadores luminosos

### Sistema de Seguridad
**Código:** `SEG-P0177-003`

Detección de sobrecalentamiento, Base antideslizante, Sistema anti-derrames
...
- **Max Ventilador de Torre** (`P0194`)
  - Comparte: Jarra
- **Advanced Humidificador** (`P0216`)
  - Comparte: Panel de control
- **Ventilador de Torre 2024** (`P0199`)
  - Comparte: Panel de control
- **Ventilador de Techo X** (`P0192`)
  - Comparte: Panel de control
- **Neblinizador** (`P0204`)
  - Comparte: Cuchillas
...
Este producto cuenta con **6 meses de garantía** contra defectos de fabricación.
...
**AirFlow** - Servicio de Atención al Cliente
...
*Documento generado: P0177 - Super Panel Calefactor Plus*
