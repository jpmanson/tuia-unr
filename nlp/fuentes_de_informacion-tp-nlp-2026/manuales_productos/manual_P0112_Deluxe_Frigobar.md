# Manual Técnico - Deluxe Frigobar

**Modelo:** P0112 | **Marca:** TechHome
...
- **Modelo:** P0112
- **Nombre Comercial:** Deluxe Frigobar
...
### Unidad Principal
**Código:** `UNI-P0112-001`

Componente central del equipo. Potencia: 500W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0112-002`

Control de temperatura, Indicadores luminosos, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0112-003`

Sistema anti-derrames, Interruptor de sobrecarga, Base antideslizante
...
*Documento generado: P0112 - Deluxe Frigobar*
