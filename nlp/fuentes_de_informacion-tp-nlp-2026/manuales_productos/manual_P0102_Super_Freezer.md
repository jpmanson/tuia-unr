# Manual Técnico - Super Freezer

**Modelo:** P0102 | **Marca:** TechHome
...
- **Modelo:** P0102
- **Nombre Comercial:** Super Freezer
- **Categoría:** Cocina - Refrigeración
- **Marca:** TechHome
- **Color:** Azul
- **Potencia:** 1950W
- **Capacidad:** 450L
...
### Unidad Principal
**Código:** `UNI-P0102-001`

Componente central del equipo. Potencia: 1950W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0102-002`

Temporizador programable, Control de temperatura, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0102-003`

Base antideslizante, Sistema anti-derrames, Apagado automático
...
- **Olla de Cocción Lenta** (`P0084`)
  - Comparte: Accesorios
- **Ultra Parrilla Eléctrica** (`P0072`)
  - Comparte: Cuchillas
- **Ultra Licuadora** (`P0008`)
  - Comparte: Panel de control
- **Freidora de Aire** (`P0055`)
  - Comparte: Motor
- **Turbo Deshidratador** (`P0147`)
  - Comparte: Jarra
...
*Documento generado: P0102 - Super Freezer*
