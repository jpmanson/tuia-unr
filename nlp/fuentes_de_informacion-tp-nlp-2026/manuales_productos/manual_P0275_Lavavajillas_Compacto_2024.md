# Manual Técnico - Lavavajillas Compacto 2024

**Modelo:** P0275 | **Marca:** FreshWash
...
- **Modelo:** P0275
- **Nombre Comercial:** Lavavajillas Compacto 2024
- **Categoría:** Lavado - Lavado de Vajilla
- **Marca:** FreshWash
- **Color:** Negro
- **Potencia:** 200W
- **Capacidad:** 10kg
...
### Unidad Principal
**Código:** `UNI-P0275-001`

Componente central del equipo. Potencia: 200W. Material: ABS de alto impacto.

### Display LED
**Código:** `PAN-P0275-002`

Interfaz intuitiva, Indicadores luminosos, Bloqueo de seguridad para niños

### Sistema de Seguridad
**Código:** `SEG-P0275-003`

Interruptor de sobrecarga, Detección de sobrecalentamiento, Fusible térmico reseteable
...
- **Lavarropa Carga Frontal** (`P0246`)
  - Comparte: Panel de control
- **Lavarropa Carga Superior** (`P0241`)
  - Comparte: Motor
- **Secarropa** (`P0259`)
  - Comparte: Cuchillas
- **Compacto Secarropa** (`P0262`)
  - Comparte: Panel de control
- **Profesional Plancha a Vapor Pro** (`P0281`)
  - Comparte: Panel de control
...
**FreshWash** - Servicio de Atención al Cliente
...
*Documento generado: P0275 - Lavavajillas Compacto 2024*
