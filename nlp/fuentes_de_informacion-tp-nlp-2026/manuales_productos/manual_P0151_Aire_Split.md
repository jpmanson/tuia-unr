# Manual Técnico - Aire Split

**Modelo:** P0151 | **Marca:** EcoClima
...
- **Modelo:** P0151
- **Nombre Comercial:** Aire Split
- **Categoría:** Climatización - Aires Acondicionados
- **Marca:** EcoClima
- **Color:** Negro
- **Potencia:** 1500W
- **Voltaje:** 220V
...
### Unidad Principal
**Código:** `UNI-P0151-001`

Componente central del equipo. Potencia: 1500W. Material: ABS de alto impacto.

### Botonera mecánica
**Código:** `PAN-P0151-002`

Control de temperatura, Indicadores luminosos, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0151-003`

Apagado automático, Bloqueo de tapa, Base antideslizante
...
- **Aire de Ventana** (`P0158`)
  - Comparte: Panel de control
- **Aire Split** (`P0149`)
  - Comparte: Accesorios
- **Radiador de Aceite II** (`P0181`)
  - Comparte: Motor
- **Advanced Neblinizador** (`P0202`)
  - Comparte: Accesorios
- **Advanced Aire Portátil Pro** (`P0157`)
  - Comparte: Jarra
...
*Documento generado: P0151 - Aire Split*
