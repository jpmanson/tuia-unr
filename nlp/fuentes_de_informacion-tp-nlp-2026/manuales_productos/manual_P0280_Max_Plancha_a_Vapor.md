# Manual Técnico - Max Plancha a Vapor

**Modelo:** P0280 | **Marca:** CleanMaster
...
- **Modelo:** P0280
- **Nombre Comercial:** Max Plancha a Vapor
...
### Unidad Principal
**Código:** `UNI-P0280-001`

Componente central del equipo. Potencia: 950W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0280-002`

Bloqueo de seguridad para niños, Temporizador programable, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0280-003`

Base antideslizante, Apagado automático, Bloqueo de tapa
...
- **Compacto Centrifuga** (`P0267`)
  - Comparte: Panel de control
- **Lavarropas Semiautomático X** (`P0236`)
  - Comparte: Jarra
- **Centro de Planchado** (`P0291`)
  - Comparte: Jarra
- **Lavavajillas Compacto** (`P0277`)
  - Comparte: Jarra
- **Centro de Planchado** (`P0292`)
  - Comparte: Motor
...
**CleanMaster** - Servicio de Atención al Cliente
...
*Documento generado: P0280 - Max Plancha a Vapor*
