# Manual Técnico - Lavarropas Automático

**Modelo:** P0230 | **Marca:** WashPro
...
- **Modelo:** P0230
- **Nombre Comercial:** Lavarropas Automático
...
- **Digital Lavaseca** (`P0255`)
  - Comparte: Motor
- **Centro de Planchado** (`P0290`)
  - Comparte: Cuchillas
- **Profesional Planchita de Pelo Plus** (`P0295`)
  - Comparte: Jarra
- **Turbo Lavaseca** (`P0252`)
  - Comparte: Accesorios
- **Deluxe Lavarropas Automático 2024** (`P0229`)
  - Comparte: Motor
...
**WashPro** - Servicio de Atención al Cliente
...
*Documento generado: P0230 - Lavarropas Automático*
