...
### Unidad Principal
**Código:** `UNI-P0113-001`

Componente central del equipo. Potencia: 1950W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0113-002`

Bloqueo de seguridad para niños, Interfaz intuitiva, Indicadores luminosos

### Sistema de Seguridad
**Código:** `SEG-P0113-003`

Sistema anti-derrames, Interruptor de sobrecarga, Apagado automático
...
- **Pava Eléctrica** (`P0127`)
  - Comparte: Jarra
- **Frigobar 2024** (`P0114`)
  - Comparte: Jarra
- **Digital Vinoteca** (`P0117`)
  - Comparte: Jarra
- **Vinoteca II** (`P0119`)
  - Comparte: Cuchillas
- **Premium Horno Eléctrico** (`P0045`)
  - Comparte: Accesorios
...
*Documento generado: P0113 - Frigobar*
