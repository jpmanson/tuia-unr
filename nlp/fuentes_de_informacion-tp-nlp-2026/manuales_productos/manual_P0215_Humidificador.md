# Manual Técnico - Humidificador

**Modelo:** P0215 | **Marca:** PureAir
...
- **Modelo:** P0215
- **Nombre Comercial:** Humidificador
- **Categoría:** Climatización - Purificación
- **Marca:** PureAir
- **Color:** Azul
- **Potencia:** 650W
- **Voltaje:** 110-220V
...
### Unidad Principal
**Código:** `UNI-P0215-001`

Componente central del equipo. Potencia: 650W. Material: ABS de alto impacto.

### Display LCD
**Código:** `PAN-P0215-002`

Interfaz intuitiva, Control de temperatura, Temporizador programable

### Sistema de Seguridad
**Código:** `SEG-P0215-003`

Sistema anti-derrames, Bloqueo de tapa, Fusible térmico reseteable
...
- **Ventilador de Techo Pro** (`P0189`)
  - Comparte: Jarra
- **Deshumidificador** (`P0218`)
  - Comparte: Panel de control
- **Deluxe Ionizador** (`P0228`)
  - Comparte: Accesorios
- **Purificador de Aire** (`P0209`)
  - Comparte: Cuchillas
- **Advanced Ventilador de Torre Pro** (`P0196`)
  - Comparte: Cuchillas
...
**PureAir** - Servicio de Atención al Cliente
...
*Documento generado: P0215 - Humidificador*
