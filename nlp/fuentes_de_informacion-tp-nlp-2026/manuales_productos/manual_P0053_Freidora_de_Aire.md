...
- **Modelo:** P0053
- **Nombre Comercial:** Freidora de Aire
...
### Unidad Principal
**Código:** `UNI-P0053-001`

Componente central del equipo. Potencia: 1400W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0053-002`

Bloqueo de seguridad para niños, Indicadores luminosos, Control de temperatura

### Sistema de Seguridad
**Código:** `SEG-P0053-003`

Interruptor de sobrecarga, Fusible térmico reseteable, Bloqueo de tapa
...
*Documento generado: P0053 - Freidora de Aire*
