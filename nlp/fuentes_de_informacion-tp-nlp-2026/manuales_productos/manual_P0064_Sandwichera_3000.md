# Manual Técnico - Sandwichera 3000

**Modelo:** P0064 | **Marca:** ChefMaster
...
- **Modelo:** P0064
- **Nombre Comercial:** Sandwichera 3000
...
### Unidad Principal
**Código:** `UNI-P0064-001`

Componente central del equipo. Potencia: 1050W. Material: ABS de alto impacto.

### Panel digital
**Código:** `PAN-P0064-002`

Indicadores luminosos, Temporizador programable, Interfaz intuitiva

### Sistema de Seguridad
**Código:** `SEG-P0064-003`

Detección de sobrecalentamiento, Interruptor de sobrecarga, Bloqueo de tapa
...
- **Compacto Rallador Eléctrico 2024** (`P0029`)
  - Comparte: Accesorios
- **Batidora de Mano** (`P0019`)
  - Comparte: Accesorios
- **Licuadora** (`P0006`)
  - Comparte: Panel de control
...
*Documento generado: P0064 - Sandwichera 3000*
